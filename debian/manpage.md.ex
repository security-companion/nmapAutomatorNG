% nmapautomatorng(SECTION) | User Commands
%
% "February 14 2026"
...
nmapautomatorng - program to do something

# SYNOPSIS

**nmapautomatorng** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**nmapautomatorng** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **nmapautomatorng** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**nmapautomatorng** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    nmapautomatorng. See **foo.conf**(5) for further details.
...
**nmapautomatorng** provides some return codes, that can be used in scripts:
...
Joachim Mammele <mail@security-companion.net>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 Joachim Mammele
